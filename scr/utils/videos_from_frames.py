...
def create_video_from_images(image_folder, output_video, fps=30, start_idx=0, end_idx=-1):
...
# Example usage:
image_folder = "../../data_splitted/data_krn_marker/val/images"  
  #image_folder = "../../data_real/lux_sat_data_real_v1"  
  #image_folder = "../../data_real/lux_sat_data_real_v4"  
...
for i in range(0, total_images, frames_per_video):
    ...
    output_video = f"../../videos/1280_leo_v1/traj_1280px_15fps_v1_val{i // frames_per_video + 1}.mp4"
    create_video_from_images(image_folder, output_video, fps=15, start_idx=start_idx, end_idx=end_idx)
