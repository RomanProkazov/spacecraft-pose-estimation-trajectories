...
if __name__ == "__main__":
    ...
    # Example Usage
    img_path = "/home/roman/spacecraft-pose-estimation-trajectories/data/images/image_00002.jpg"  # Replace with your image path
    ...
    # Save the heatmap
    cv2.imwrite("../../heatmap_output/2.jpg", output_img)