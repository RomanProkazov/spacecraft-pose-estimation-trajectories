...
image_dir = Path('calibration_images2')
...
square_size = 100  # mm
pattern_size = (9, 6)  # number of inner corners
...
for i in range(len(obj_points)):
    ...
    error = cv2.norm(img_points[i], imgpoints2.reshape(-1, 2)[i], cv2.NORM_L2) / len(imgpoints2)
