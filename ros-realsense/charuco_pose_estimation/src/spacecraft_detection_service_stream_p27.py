...
class SpacecraftVisualizer:
    def __init__(self):
        ...
        if not os.path.exists(self.OUTPUT_IMGan_DIR):
            os.makedirs(self.OUTPUT_IMGan_DIR)
        ...
        try:
            ...
            if ids is not None:
                ...
                for i, marker_id in enumerate(ids):
                    ...
                    cv2.putText(annotated_image, "ID:{}".format(marker_id[0]), tuple(center),
            ...
            if save_output:
                ...
                # Save images
                original_filename = "{}/image_{}.jpg".format(self.OUTPUT_IMG_DIR, timestamp)
                annotated_filename = "{}/imagean_{}.jpg".format(self.OUTPUT_IMGan_DIR, timestamp)
                cv2.imwrite(original_filename, cv_image)
                cv2.imwrite(annotated_filename, annotated_image)
                
                # Save JSON data
                json_filename = "{}/image_{}.json".format(self.OUTPUT_JSON_DIR, timestamp)
                data = {
                    "timestamp": timestamp,
                    "original_image_path": "image_{}.jpg".format(timestamp),
                    "translation": [
            ...
            rospy.logerr("Processing error: {}".format(str(e)))
            return None
        ...
        while not rospy.is_shutdown():
            ...
            if annotated_img is not None:
                try:
                    ...
                    rospy.logerr("Stream publishing error: {}".format(str(e)))
